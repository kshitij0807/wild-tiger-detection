...
# from model_training.detection.backbones import get_backbone
    ...
    def _create_extra(in_channels):
        layers = nn.ModuleList([
            nn.Sequential(
                ...
                nn.Conv2d(in_channels=in_channels, out_channels=256, kernel_size=1, padding = 1),
                nn.ReLU(),
                nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, stride=2, padding=1),
                nn.ReLU()
            ),
            nn.Sequential(
                nn.Conv2d(in_channels=512, out_channels=128, kernel_size=1),#, padding = 1),
                nn.ReLU(),
