...
def _create_mobilenet(pretrained=True, weights=None):
    ...
    # return nn.ModuleDict({'layer0': nn.Sequential(*deepcopy(features[0:4])),
    #                       'layer1': nn.Sequential(*deepcopy(features[4:7])),
    #                       'layer2': nn.Sequential(*deepcopy(features[7:11])),
    #                       'layer3': nn.Sequential(*deepcopy(features[11:16])),
    #                       'layer4': nn.Sequential(*deepcopy(features[16:20]))}), dims
